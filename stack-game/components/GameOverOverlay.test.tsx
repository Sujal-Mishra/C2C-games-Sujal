...
test("shows a pixel game-over message and the best score without actions", () => {
  render(<GameOverOverlay bestScore={400} />);
  ...
  expect(screen.getByText("Best score: 400")).toHaveClass("final-score", "etched-wood-text");
